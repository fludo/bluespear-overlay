...
SRC_URI="!binary? ( http://www.scala-lang.org/downloads/distrib/files/scala-2.9.0.RC2-sources.tgz )
                binary? ( http://www.scala-lang.org/downloads/distrib/files/scala-2.9.0.RC2.tgz )"
LICENSE="BSD"
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="binary emacs"
